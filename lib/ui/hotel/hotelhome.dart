...
final List rooms = [
  {"image": "assets/images/room1.jpg", "title": "Awesome room near Kakkanad"},
  {"image": "assets/images/room2.jpg", "title": "Peaceful Room"},
  {"image": "assets/images/room3.jpg", "title": "Beautiful Room"},
  {"image": "assets/images/room4.jpg", "title": "Vintage room near Kochi"},
];
//room[image][index]
...
class HotelHomePage extends StatelessWidget {
  ...
  Widget _buildRooms(BuildContext context, int index) {
    var room = rooms[index % rooms.length];  //room[image][index]
